...
/**
 * Trying to understand the internals of mock framework based on proxy.
 * This is a very simple implementation of a mock framework.
 * It is based on cglib proxy (can create proxy of any type, type could be defined as class). 
 * The API is similar to the API of Mockito.
 */
